...
Streaming or compaction state the stream set while the history was paged in is newer than the page and wins over it, and a cold resume, on a fresh app-server that can be running no turn, adopts none.
